...
COPY ./model-creation/requirements.txt ./model-creation/requirements.txt
#COPY ./requirements-all.txt .

# Install dependencies
RUN pip install --requirement ./model-creation/requirements.txt
